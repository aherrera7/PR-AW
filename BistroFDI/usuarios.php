...
foreach ($usuarios as $u) {
  ...
  // lápiz edita datos del usuario, botón cambia rol
  ...
  $rows .= '
    <li class="useritem">
      ...
      <form method="post" style="display:inline;">
        ...
        <button class="icon-btn" type="submit" title="Eliminar" onclick="return confirm(\'¿Eliminar este usuario?\');">'.$iconTrash.'</button>
      </form>
